    ...
    <>
      ...
      <div id="modal" className='modal'>
        <div className='modal__container'>
          ...
          <h1>Szabályok</h1>
          <p>
            Ha valaki az alábbi szavakat kimondja, akkor pörgetnie kell egy feladatot. A feladat elvégzése kötelező, ha nem tudja / akarja teljesíteni, akkor a menyasszony szabja ki a büntetést.
          </p>
          <p> Az alábbi szavak tiltottak: </p>
          <p className='word__list'>menyasszony, *menyasszony neve*, *tanú neve*, esküvő, Igyál!, fehér, koktél, pörget</p>
          <p>
